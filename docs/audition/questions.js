window.AUDITION_DATA = {
  ...
  "questions": [
    ...
    },
    {
      "id": "q003",
      "type": "T1_distance",
      "question": "You hear two recordings of the same sound source at the same direction in the same room. It emitted the same signal at the same power; only its distance may differ. In which recording is the source closer?",
      "options": [
        "the source is closer in the first recording",
    ...
    },
    {
      "id": "q009",
      "type": "T2_fb",
      "question": "Before you turned, one stationary sound source was either directly in front of you or directly behind you. The source stayed fixed in the room while you turned 45 degrees to your right without walking. You hear only the recording made after the turn. Where was the source before you turned?",
      "options": [
